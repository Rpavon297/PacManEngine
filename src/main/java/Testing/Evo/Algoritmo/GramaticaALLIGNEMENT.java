...
public class GramaticaALLIGNEMENT extends PacmanController {
    /**
     *       <S> = <exp>
    ...
    public GramaticaALLIGNEMENT(List<Double> codones){
        wraps = 0;
        maxWraps = DEFAULT_SETTINGS[0];
        fleeDist = DEFAULT_SETTINGS[1];
        chaseDist = DEFAULT_SETTINGS[2];
    ...
    public GramaticaALLIGNEMENT(int maxWraps, int fleeDist, int chaseDist, int pillDist){
        this.wraps = 0;
